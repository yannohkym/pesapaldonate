...
{
    private  $consumer_key = '';//Register a merchant account on
    ...
    public function new( Request $request){
        ...
        if($donation->save()){
            ...
            return redirect()->route('donation_process.donation_pay',['id'=>$donation->id]);
        }else{
    ...
    public function pay($donation_id){
        ...
        return view('pay',['iframe'=>$iframe_src]);
    ...
    public function pesapal(Donation $donation){
        ...
        */
        ...
        $consumer_secret = $this->consumer_secret;// Use the secret from your test
